# Now create the enhanced booking section and order status tracking
app_part3 = '''
...
# Save the booking section
with open('app_part3.js', 'w') as f:
    f.write(app_part3)

print("Created enhanced booking section with order ID generation and popup")