# Continue with the hero section and other components
app_part2 = '''
// Hero Section
const HeroSection = () => {
...
with open('app_part2.js', 'w') as f:
    f.write(app_part2)

print("Created second part with Hero, Services, Portfolio and Testimonials sections")